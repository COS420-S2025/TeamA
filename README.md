...
### Draft 1
- Syllabi can be long and full of non-due date information. 
- We find it hard and time consuming to plot out due dates of assignments and exams when given a syllabus. 
- It is tedious to go through the process of accessing and reading a syllabus to find the due date for a specific assignment, especially for each assignment. 
- Reducing the difficulty in this process would free up more time for students to study and actually do assignments. 
- There are solutions that currently address this exact problem but many are paid or use AI. 
- How can this busywork be reduced?
